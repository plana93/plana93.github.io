...
overline: "[ACHIEVEMENT] 2021 & 2022 · CVPR Workshop"
permalink: /ek100-challenge/
description: "Two-time consecutive winner of the Unsupervised Domain Adaptation Challenge — 3rd place in both 2021 and 2022 at CVPR."
nav: false
---

<!-- Achievement summary -->
<div class="p-callout p-reveal">
  <p class="p-callout__eyebrow">ACHIEVEMENT SUMMARY</p>
  <p class="p-callout__body">
    Two-time consecutive winner of the Unsupervised Domain Adaptation Challenge —
    <strong>3rd place in both 2021 and 2022</strong> at CVPR.
  </p>
  <p class="p-callout__meta">Politecnico di Torino · Computer Vision · Egocentric Action Recognition</p>
</div>
...
<section class="p-section p-section--tight p-reveal">
  <div class="p-year-block">
    <div class="p-year-block__header">
      <h2 class="p-year-block__title">2022 — CVPR Workshop</h2>
      <span class="p-pill p-pill--purple">3RD PLACE</span>
    </div>
    <div class="p-gallery-grid p-gallery-grid--single">
      <div class="p-gallery-img">
        <img src="/assets/img/EK100_Challenge_2021_2022/ek_100_2022.jpeg"
             alt="EPIC-KITCHENS 2022 challenge results" loading="lazy">
      </div>
    </div>
    <p class="p-body" style="margin-top:1.5rem">
      Our <strong>"Multi-Source Multi-Target Unsupervised Domain Adaptation"</strong> approach
      secured a position among the top 3 teams at the EPIC-KITCHENS-100 UDA Challenge
    ...
    <div class="p-infobox p-reveal">
      ...
      <p>
        <strong>Key Innovation:</strong> A novel approach to leverage multiple source domains
        while adapting to multiple unlabeled target domains simultaneously, achieving robust
...
<section class="p-section p-section--tight p-reveal">
  <div class="p-year-block">
    <div class="p-year-block__header">
      <h2 class="p-year-block__title">2021 — CVPR Workshop</h2>
      <span class="p-pill p-pill--teal">3RD PLACE</span>
    </div>
    <div class="p-gallery-grid p-gallery-grid--single">
      <div class="p-gallery-img">
        <img src="/assets/img/EK100_Challenge_2021_2022/winners-2021.png"
             alt="EPIC-KITCHENS 2021 challenge winners" loading="lazy">
      </div>
    </div>
    <p class="p-body" style="margin-top:1.5rem">
    ...
    <div class="p-infobox p-reveal">
      ...
      <p>
        ...
        loss originally proposed for Domain Generalization, to operate between different backbone
...
<!-- Dataset -->
<section class="p-section p-section--tight p-reveal">
  <span class="p-overline">About the Dataset</span>
  <h2 class="p-h2">EPIC-KITCHENS-<span class="p-accent">100</span></h2>

  <p class="p-body">
    The largest-scale egocentric dataset, collected by 32 participants in their native kitchen
    environments, densely annotated with actions and object interactions.
  </p>

  <div class="p-stat-row">
    <div class="p-stat">
      <span class="p-stat__num">125</span>
      <span class="p-stat__label">Verb Classes</span>
    </div>
    <div class="p-stat">
      <span class="p-stat__num">331</span>
      <span class="p-stat__label">Noun Classes</span>
    </div>
    <div class="p-stat">
      <span class="p-stat__num">32</span>
      <span class="p-stat__label">Participants</span>
    </div>
  </div>
